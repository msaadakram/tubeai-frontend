            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button
                  size="lg"
                  asChild
                  className="w-full sm:w-auto h-14 px-8 text-lg gap-2 bg-white text-red-600 hover:bg-red-50 rounded-full font-bold shadow-lg"
                >
                  <Link href={getLocalePath(locale, "/signup")}>
                    {t("cta.startFree")} <ArrowRight className="w-5 h-5" />
                  </Link>
                </Button>
