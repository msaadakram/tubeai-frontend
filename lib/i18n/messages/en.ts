...
free: {
  ...
  auth: {
    ...
    verificationResendFailed: "Couldn't send the email right now. Please try again in a minute.",
    verificationTitle: "Check your inbox",
    verificationDesc: "We sent a verification link to",
    verificationStepsTitle: "Next steps",
    verificationStep1: "Open the email from noreply@ytforge.app",
    verificationStep2: "Click the red 'Verify email' button",
    verificationStep3: "You're in — start creating",
    verificationResend: "Resend email",
    verificationResendIn: "Resend in",
    verificationGoDashboard: "Continue to dashboard",
    verificationSpam: "Didn't get it? Check your spam folder — or resend below.",
