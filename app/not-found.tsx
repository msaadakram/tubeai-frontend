  ...
  return (
    <div className={`${dark ? "dark" : ""} min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans selection:bg-red-600/20`}>
      <div className="flex flex-col min-h-screen">
        <header className="border-b-2 border-black dark:border-neutral-800 bg-white/85 dark:bg-neutral-950/85 backdrop-blur-xl">
          <div className="container mx-auto px-4 sm:px-6 h-16 sm:h-18 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 group shrink-0">
              <div className="w-9 h-9 rounded-xl bg-red-600 flex items-center justify-center border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.15)] group-hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:group-hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 transition-all">
                <Play className="w-4 h-4 text-white fill-white" />
              </div>
              <span className="font-black text-lg sm:text-xl tracking-tight text-black dark:text-white">YTForge</span>
            </Link>
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-black text-white bg-red-600 rounded-xl border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.15)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all"
            >
        ...
        <footer className="border-t-2 border-black dark:border-neutral-800 bg-black dark:bg-black text-white py-8">
          <div className="container mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="w-8 h-8 rounded-lg bg-red-600 flex items-center justify-center border-2 border-white/30 shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)]">
                <Play className="w-4 h-4 text-white fill-white" />
              </div>
              <span className="font-black text-base tracking-tight">YTForge</span>
            </Link>
            <p className="text-xs text-neutral-500 text-center">
              &copy; {year} YTForge. Made for creators worldwide.
            </p>
            <div className="flex items-center gap-4">
              <Link href="/" className="text-xs text-neutral-500 hover:text-white transition-colors">
                Home
              </Link>
              <Link href="/pricing" className="text-xs text-neutral-500 hover:text-white transition-colors">
                Pricing
              </Link>
