...
const quickLinks = [
  { labelKey: "tools.viralTitleGenerator.title", href: "/tools/viral-title-generator", icon: TrendingUp },
  { labelKey: "tools.aiScriptWriter.title", href: "/tools/ai-script-writer", icon: PenTool },
  { labelKey: "tools.thumbnailDownloader.title", href: "/tools/thumbnail-downloader", icon: Download },
  { labelKey: "tools.seoAnalyzer.title", href: "/tools/seo-analyzer", icon: LineChart },
  { labelKey: "tools.aiTranscript.title", href: "/tools/ai-transcript", icon: FileText },
  { labelKey: "tools.hashtagGenerator.title", href: "/tools/hashtag-generator", icon: Hash },
];
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 mt-8 sm:mt-10">
                ...
                <Link
                  href={getLocalePath(locale, "/tools")}
                  style={{ boxShadow: shadowBase }}
        ...
        <section className="border-t-2 border-black dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 py-14 sm:py-16">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 max-w-4xl mx-auto">
              {quickLinks.map(({ labelKey, href, icon: Icon }) => (
                <Link
                  key={href}
